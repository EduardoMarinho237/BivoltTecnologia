...
export default function About() {
  ...
  return (
    <section id="about" className="min-h-[80vh] flex flex-col items-center justify-center bg-gray-100 py-16">
      <div className="max-w-3xl text-center px-8">
        ...
        <div className="flex items-center justify-center mt-8">
          ...
          <img src="/images/notebook.webp" alt="Notebook" className="w-full" />
        </div>
      </div>
